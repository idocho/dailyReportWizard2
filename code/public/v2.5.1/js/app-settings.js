...
function renderClsMgmt(){
  // 강사도 전체 학급 드릴인 가능 — 과정·교재(courses) 추가/삭제용. 학급·학생 CRUD는 여기 없음(학생 명단 탭·관리자).
...
function renderClsMgmtTop(){
  ...
  return `<div class="card">
    ...
    <div class="sh2">전체 학급 탐색 <span style="font-weight:400;font-size:10px;color:var(--gray)">· 과정·교재 관리 (학급·학생 추가·삭제는 ‘학생 명단’ 탭 — 관리자)</span></div>
