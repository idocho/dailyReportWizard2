...
# 산출물: code/dist/DRW-AI-Agent-0.94.exe  (build/·dist/·*.spec 은 gitignore)
param([switch]$Clean)
...
Write-Host "`n[완료] code/dist/DRW-AI-Agent-0.94.exe" -ForegroundColor Green
